...
class AutoMonitor:
    ...
    def start_monitoring(self):
        ...
        self.telegram.send_message(
            ...
            "✅ Bug auto-fixing enabled\n"
            "✅ Telegram alerts configured\n"
            "✅ Position monitoring ready\n\n"
            "You'll receive automatic updates on:\n"
            "• New trading signals\n"
    ...
    def _check_system_health(self) -> Dict:
        ...
        try:
            ...
            if not self.telegram.bot_token or not self.telegram.chat_id:
                issues.append("telegram_not_configured")
    ...
    def _alert_new_signal(self, signal: Dict):
        ...
        self.telegram.send_message(message, urgent=True)
    ...
    def _restart_component(self, component: str):
        ...
        try:
            ...
            self.telegram.send_message(f"✅ Component Restarted: {component}")
